            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    <Link to="/" className="flex items-center gap-2">
                        ...
                        <span className="text-xl font-bold tracking-tight text-slate-800">Granted</span>
                    </Link>
                    <div className="hidden md:flex space-x-8 text-sm font-medium text-slate-600">
                        <Link to="/discover" className="hover:text-[#0F766E] transition-colors">Discover</Link>
                        <Link to="/my-grants" className="hover:text-[#0F766E] transition-colors">My Grants</Link>
                        <Link to="/resources" className="hover:text-[#0F766E] transition-colors">Resources</Link>
                        {isAuthenticated && (
                            <Link to="/admin" className="hover:text-[#0F766E] transition-colors">Admin</Link>
                        )}
                    </div>
