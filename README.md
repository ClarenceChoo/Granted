# Granted — Developer Guide & Hackathon Project

![Landing image](assets/landing-page.png)

This repository contains the Granted AI Grant Discovery platform and our Hackathon entry. It combines a React + TypeScript frontend and a Python backend (serverless functions included). Below you'll find setup instructions, a brief overview of the hackathon project, the problem statement, and next steps.
...
- **Interactive Profiling**: instead of filling forms, NPOs chat with our bot. It "interviews" them to understand mission, budget, and KPIs and converts conversational answers into a structured `Profile_JSON`.
- **Curator**: a scheduled digest ranks opportunities using vector similarity and matching logic (including grant quantum vs. project size) and surfaces a high-confidence "Top 3".
...
- Database: schema tracking `Profile_JSON`, vector embeddings, and frequency preferences
- Notifications: Resend + React Email to generate mobile-responsive summaries
...
This was developed as a hackathon project; adapt or extend the design for production use.
